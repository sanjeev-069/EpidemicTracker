...
namespace EpidemicTrackerApplication.Repositories.Services
{
    public class HospitalRepository : IHospitalRepository
    {
        ...
        public List<Hospital> GetHospitalId(int id)
        {
            ...
            //}).ToList<Hospital>();
            hospital = _context.Hospitals.Where(o => o.HospitalId == id).ToList();
            return hospital;
        }
        ...
        public HospitalDTO Update(int id, HospitalDTO hospitalDTO)
        {
